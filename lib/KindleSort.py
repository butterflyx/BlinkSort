...
class KindleSort(BlinkSort.BlinkSort):
    ...
    # annotations = { "booktitle" : booktitle, "author": author, "last_access": last_access, "chapters" : [{ number_chapter : {"chapter_title": chapter_title , "annotations" : [annotation_1 ,... annoation_n] }] }
    ...
    def set_title(self) -> str:
        ...
        self.textlist.pop(0)
        self.textlist.pop(0) # dicard meta information of number of highlight and notes
